...
export const appCategories: AppCategoryConfig[] = [
  ...
  { id: "team", label: "Team", color: "teal", order: 8 },
];
...
export const apps: AppConfig[] = [
  ...
  },
  {
    id: "showings",
    name: "Showings",
    description: "Schedule open houses with shareable public sign-up links, capacity tracking, AppFolio guest card sync, and a .ics feed for the team calendar",
    href: "/showings",
    icon: "Calendar",
    category: "leasing",
    categoryLabel: "Leasing",
  ...
  // --- Team (internal) ---
  {
    id: "meetings",
    name: "Meetings",
    description: "Weekly team meetings with live transcription, AI-extracted action items, comments, and attachments — carry-over tasks surface automatically at the next meeting",
    href: "/meetings",
    icon: "Calendar",
    category: "team",
    categoryLabel: "Team",
  ...
  },
  {
    id: "users",
    name: "Users & Access",
    description: "Manage team member logins, roles, and permissions across Moxie",
    href: "/users",
    icon: "Users",
    category: "team",
    categoryLabel: "Team",
